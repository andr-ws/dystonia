...
for i = 1:length(ids)
    ...
    input_file = sprintf('/Users/neuro-239/imaging/datasets/cd/derivatives/leaddbs/sub-%d/stimulations/MNI152NLin2009bAsym/gs_direc/sub-%d_sim-binary_model-simbio_hemi-R.nii', id, id);
